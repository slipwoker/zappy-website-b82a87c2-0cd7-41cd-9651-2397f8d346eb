document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function clearError(field) {
      const wrapper = field.closest('.form-group, .field-wrapper, div') || field.parentElement;
      field.classList.remove(ERROR_CLASS);
      wrapper.classList.remove(ERROR_CLASS);

      const existingError = wrapper.querySelector('.field-error-msg');
      if (existingError) {
        ...
        .then(function (response) {
          if (response.ok) {
            ...
            setTimeout(function () {
              ...
              contactForm.classList.remove(SUCCESS_CLASS);
            }, 6000);
          } else {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'b82a87c2-0cd7-41cd-9651-2397f8d346eb',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'b82a87c2-0cd7-41cd-9651-2397f8d346eb';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'b82a87c2-0cd7-41cd-9651-2397f8d346eb';
